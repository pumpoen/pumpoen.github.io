...
function coolUrlBaby () {
  window.history.pushState('page2', 'Title', '/fun/clausPrequel?page=' + sceneIndex);
}

function getPageByUrlQuery () {
  for (i = 0; i <= scenes.length; i++) {
    if (((window.location.href) === ("https://schoolworkcity.neocities.org/fun/clausPrequel?page=" + i))||(window.location.href) === ("https://schoolworkcity.neocities.org/fun/clausPrequel/?page=" + i)) {
      sceneIndex = i;
    }
  }
}
